...
{
       0,   106,   106,   109,   114,   118,   122,   128,   131,   136,
     150,   156,   159,   165,   168,   173,   183,   188,   194,   197,
     200,   203,   206,   209,   212,   217,   227,   230,   236,   241,
     247,   252,   257,   263,   275,   279,   286,   291,   296,   301,
     304,   309,   313,   317,   321,   327,   331,   336,   341,   346,
     351,   356,   363,   367,   371,   377,   381,   385,   391,   395,
     399,   402,   408,   416,   421,   427
};
#endif
...
#line 137 "CminusParser.y"
			...
			int i = SymQueryIndex(tab, (yyvsp[-3].string));
			if (i == SYM_INVALID_INDEX) {
				i = SymIndex(tab, (yyvsp[-3].string));
...
#line 174 "CminusParser.y"
			...
			int i = SymQueryIndex(tab, (yyvsp[0].string));
			if (i != SYM_INVALID_INDEX) exit(1);
		
			i = SymIndex(tab, (yyvsp[0].string));
...
#line 1430 "CminusParser.c"
    break;

  case 25: /* Assignment: Variable ASSIGN Expr SEMICOLON  */
#line 218 "CminusParser.y"
                {
			SymTable tab = findSymtab(stack, (yyvsp[-3].var).name);
			if (!tab) exit(1);
			int i = SymQueryIndex(tab, (yyvsp[-3].var).name);
			if (i == SYM_INVALID_INDEX) exit(1);
			SymPutFieldByIndex(tab, i, "v", (yyvsp[-1].num));
		}
...
#line 332 "CminusParser.y"
                {
			if ((yyvsp[-2].num) == (yyvsp[0].num)) (yyval.num) = 1;
			else (yyval.num) = 0;
		}
...
#line 409 "CminusParser.y"
                {
			SymTable tab = findSymtab(stack, (yyvsp[0].string));
			int i = SymQueryIndex(tab, (yyvsp[0].string));
